 ...
 */
require get_template_directory().'/inc/ansar/hooks/hook-breking-news-header-posts.php';
 ...
 * post crowsel.
 */
require get_template_directory().'/inc/ansar/hooks/hook-front-page-crowsel-posts.php';
