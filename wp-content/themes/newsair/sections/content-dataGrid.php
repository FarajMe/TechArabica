...
<div id="post-<?php the_ID(); ?>" <?php if($newsair_content_layout == "grid-fullwidth") { echo post_class('col-lg-4 col-md-6'); } else { echo post_class('col-md-6'); } ?>>
