<?php
if (!function_exists('newsvoice_front_page_banner_section')) :
  /**
   *
   * @since newsair
   *
   */
  function newsvoice_front_page_banner_section() {
          ...
          <div class="multi-post-widget mb-0">
            ...
            <?php if ($newsair_all_posts_main->have_posts()) : 
              ...
              $newsair_url = newsair_get_freatured_image_url($post->ID, 'newsair-slider-full');
                ?>
                <div class="bs-blog-post three sm back-img bshre mb-4" <?php if (!empty($newsair_url)): ?>
...
add_action('newsvoice_action_front_page_main_section_1', 'newsvoice_front_page_banner_section', 40); 