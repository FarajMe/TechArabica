<?php  
class Newsvoice_Custom_Radio_Default_Image_Control extends WP_Customize_Control {
...
$wp_customize->add_setting(
    'newsvoice_content_layout', array(
    'default'           => 'align-content-right',
    'sanitize_callback' => 'newsair_sanitize_radio'
) );

$wp_customize->add_control(
    new Newsvoice_Custom_Radio_Default_Image_Control( 
        // $wp_customize object
        $wp_customize,
        // $id
        'newsvoice_content_layout',
        // $args
        array(
            'settings'      => 'newsvoice_content_layout',
