...
class Desert_Companion_Customize_Upgrade_Control extends WP_Customize_Control {
	...
	protected function render_content() {
		...
		elseif('NewsMash' == $desert_activated_theme->name || 'NewsDaily' == $desert_activated_theme->name || 'DayStory' == $desert_activated_theme->name  || 'NewsAlt' == $desert_activated_theme->name):
			$upgrade_to_pro_link = 'https://desertthemes.com/themes/newsmash-pro/';
		elseif('NewsMunch' == $desert_activated_theme->name):
